...
<!-- Mirrored from www.cliptheme.com/demo/rapido/table_data.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Feb 2016 11:59:09 GMT -->
<head>
		<title>SafePal</title>
		<!-- start: META -->
		<meta charset="utf-8" />
					...
					<div class="main-navigation left-wrapper transition-left">
						...
						<ul class="main-navigation-menu">
                            ...
                            <li class="active open">
								<a href="tab.php"><i class="fa fa-book"></i> <span class="title"> Survivor Report </span></a>
							</li>
                            
                            <li >
								<a href=""><i class="fa fa-envelope-o"></i> <span class="title"> messages </span></a>
							</li>
							...
							<div class="col-md-12">
								...
								<div class="panel panel-white">
									<div class="panel-heading">
										<h4 class="panel-title">Report<span class="text-bold">Table</span></h4>
									...
									<div class="panel-body">
										...
										<div class="table-responsive">
											<table class="table table-striped table-hover" id="sample_2">
												...
												<tbody><?php
$count=1;
$sel_query="Select * from report ORDER BY case_No desc;";
$result = mysql_query($sel_query);
while($row = mysql_fetch_assoc($result)) { ?>
<tr>
  
    <td align="center"><?php echo $row["ei_phoneNumber"]; ?></td>
    <td align="center"><?php echo $row["ei_gender"]; ?></td>
    <td align="center"><?php echo $row["ei_age"]; ?></td>
    <td align="center"><?php echo $row["ti_location"]; ?></td>
    <td align="center"><?php echo $row["ti_description"]; ?></td>
    <td align="center"><?php echo $row["ti_type"]; ?></td>
    <td align="center"><?php echo $row["ti_action"]; ?></td>
    <td><a href="#responsive" class="demo btn btn-blue">HELP</a></td>
...
<!-- Mirrored from www.cliptheme.com/demo/rapido/table_data.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 17 Feb 2016 11:59:12 GMT -->
</html>